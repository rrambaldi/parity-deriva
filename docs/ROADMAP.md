...
| fase | cosa | stato |
|---|---|---|
| 1 | **singola strategia**: da un'idea a un trade live | fatta su dev il 2026-09-26, non ancora in produzione · [PROCESSO.md](PROCESSO.md), piano in [PIANO-FASE1.md](PIANO-FASE1.md) |
