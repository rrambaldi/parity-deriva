...
`ponytail:` no ADX yet - add it to lib/streaming.Series when a feature needs
it; the indicators uploaded by an assistant are the next step (C4b2).
"""
...
NAMES = ('rsi14', 'atrpct14', 'dist_sma100_atr', 'range_atr14', 'slope100', 'hour', 'weekday')


class Features(object):

	def __init__(self):
		self.series = Series(sma=(), atr=14, rsi=14, keep=120)
		self.last = None
